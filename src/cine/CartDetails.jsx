        ...
        >
          ...
          >
            <div className="grid grid-cols-[1fr_auto] gap-4">
              { state.cartData.length === 0 ? (<p className="text-2xl font-bold text-red-500">Cart is Empty</p>) : (state.cartData.map((movie)=>(
                < >
                <div key={movie.id}  className="flex items-center gap-4">
                <img
                  className="rounded overflow-hidden"
                  src={getAllImageUrl(movie.cover)}
                  alt={movie.title}
                  width="50px"
                  height="50px"
                />
              ...
              <div className="flex justify-between gap-4 items-center">
                ...
                >
                  ...
                  <span className="max-md:hidden" onClick={(e)=>handleRemoved(e, movie)} >Remove</span>
                </button>
              </div>
                </>
              )))}
